...
@WebServlet("/GetDataSection")
public class GetDataBySectionId extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException
     {
		 //response.setContentType("text/html;charset=UTF-8");
			...
			try{
	            ...
	            ResultSet rs=st.executeQuery("select Section from Class where Class_Id ='"+class_id+"'");
